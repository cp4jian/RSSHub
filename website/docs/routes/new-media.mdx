...
## Offical HIGE DANdism Official髭男dism {#official-hige-dandism}

### Homepage Information 官网 新闻 {#official-hige-dandism-homepage-information-guan-wang-xin-wen}

<Route author="cp4jian" example="/higedan/hp/infomation/2" path="/higedan/hp/information/:maxPages?" paramsDesc={['Max Fetch Pages, `1` by default']} />
